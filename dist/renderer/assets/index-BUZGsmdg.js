...
var Link = reactExports.forwardRef(
  function LinkWithRef({
    ...
    let { basename: basename2, navigator: navigator2, unstable_useTransitions } = reactExports.useContext(NavigationContext);
...
const SidebarMenu = () => {
  ...
  const handleClick = (path2) => {
    navigate(path2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "sidebar-menu", children: menuItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      className: `sidebar-menu-item ${isActive(item.path) ? "active" : ""}`,
      onClick: () => handleClick(item.path),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { size: 18, className: "menu-icon" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "menu-label", children: item.label })
      ]
    },
    item.key
  )) });
...
const useChatStore = create$1()((set, get) => ({
  ...
  deleteThread: (id2) => {
    const state = get();
    const thread = state.threads.find((t2) => t2.id === id2);
    if (thread) {
      deleteThreadFromDisk(id2);
    }
    threadHasMessages.delete(id2);
    set((state2) => ({
      threads: state2.threads.filter((t2) => t2.id !== id2),
      currentThreadId: state2.currentThreadId === id2 ? null : state2.currentThreadId,
      currentThread: state2.currentThreadId === id2 ? null : state2.currentThread
    }));
  },
  updateThread: (id2, updates) => set((state) => {
    const updatedThreads = state.threads.map(
      (t2) => t2.id === id2 ? { ...t2, ...updates, updatedAt: Date.now() } : t2
    );
    const updatedThread = updatedThreads.find((t2) => t2.id === id2);
    if (updatedThread) {
      saveThreadToDisk(updatedThread);
    }
    return {
      threads: updatedThreads,
      currentThread: state.currentThreadId === id2 ? { ...state.currentThread, ...updates, updatedAt: Date.now() } : state.currentThread
    };
  }),
  setCurrentThread: (id2) => set((state) => {
    if (id2 === null) {
      return { currentThreadId: null, currentThread: null };
    }
    const thread = state.threads.find((t2) => t2.id === id2) || (state.currentThread?.id === id2 ? state.currentThread : null);
    return { currentThreadId: id2, currentThread: thread };
  }),
  getThread: (id2) => get().threads.find((t2) => t2.id === id2),
  addMessage: (threadId, message) => set((state) => {
    const isFirstMessage = !threadHasMessages.has(threadId);
    threadHasMessages.add(threadId);
    let thread = state.threads.find((t2) => t2.id === threadId);
    if (!thread) {
      if (isFirstMessage) {
        thread = {
          id: threadId,
    ...
    if (isFirstMessage && message.role === "user") {
      newThreads = [updatedThread, ...state.threads.filter((t2) => t2.id !== threadId)];
    } else {
      newThreads = state.threads.map((t2) => t2.id === threadId ? updatedThread : t2);
    }
    return {
      threads: newThreads,
  ...
  updateMessage: (threadId, messageId, updates) => set((state) => {
    const updatedThreads = state.threads.map(
      (t2) => t2.id === threadId ? {
        ...t2,
        messages: t2.messages.map(
          (m2) => m2.id === messageId ? { ...m2, ...updates } : m2
        )
      } : t2
    );
    const updatedThread = updatedThreads.find((t2) => t2.id === threadId);
    if (updatedThread) {
      saveThreadToDisk(updatedThread);
    }
    return {
  ...
  clearMessages: (threadId) => set((state) => {
    const updatedThreads = state.threads.map(
      (t2) => t2.id === threadId ? { ...t2, messages: [], updatedAt: Date.now() } : t2
    );
    const updatedThread = updatedThreads.find((t2) => t2.id === threadId);
    if (updatedThread) {
      saveThreadToDisk(updatedThread);
    ...
    return {
      threads: updatedThreads,
      currentThread: state.currentThreadId === threadId ? { ...state.currentThread, messages: [] } : state.currentThread
    };
  }),
  addArtifact: (threadId, artifact) => set((state) => ({
    threads: state.threads.map(
      (t2) => t2.id === threadId ? {
        ...t2,
        messages: t2.messages.map(
          (m2) => m2.role === "assistant" ? { ...m2, artifacts: [...m2.artifacts || [], artifact] } : m2
        )
      } : t2
    )
  })),
  ...
  loadSessionsFromDisk: async () => {
    ...
    try {
      ...
      if (sessions && sessions.length > 0) {
        const sorted = sessions.filter((s) => s && s.id && s.messages && s.messages.length > 0).sort((a, b) => (b.updatedAt || 0) - (a.updatedAt || 0)).slice(0, 50);
        sorted.forEach((t2) => threadHasMessages.add(t2.id));
...
const ConfirmDialog = ({
  ...
  return reactDomExports.createPortal(
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "confirm-overlay", onClick: onCancel, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "confirm-dialog", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "confirm-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "confirm-title", children: title }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "confirm-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: message }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "confirm-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "confirm-cancel", onClick: onCancel, children: "取消" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "confirm-ok", onClick: onConfirm, children: "确定" })
      ] })
    ] }) }),
    document.body
  );
...
const ConfirmDialogManager = () => {
  const [state, setState] = reactExports.useState(confirmCallback);
  reactExports.useEffect(() => {
...
const RecentThreads = () => {
  ...
  const handleDelete2 = async (threadId) => {
    const ok2 = await confirm("确定要删除这个对话吗？", "确认删除");
    if (ok2) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recent-threads", ref: menuRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "recent-header", children: "最近对话" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recent-list", children: [
      recentThreads.map((thread) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            editingId === thread.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
              ...
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "recent-title", children: thread.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "recent-time", children: formatTime(thread.updatedAt) })
                ]
              }
            ),
            ...
            openMenuId === thread.id && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recent-menu", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  onClick: () => handleDelete2(thread.id),
                  children: [
      ...
      recentThreads.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "recent-empty", children: "暂无对话记录" })
    ] })
  ] });
};
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-actions", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          title: collapsed ? "设置" : void 0,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 18 }),
            !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "设置" })
          ]
        }
      )
    ] }),
    !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(RecentThreads, {})
    ] })
  ] });
};
const Header = ({ sidebarCollapsed, onToggleSidebar }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "app-header", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-right", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "header-btn close", onClick: handleClose, children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 18 }) })
    ] })
  ] });
};
const quickActions = [
...
const QuickActions = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "quick-actions", children: quickActions.map((action) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
...
const Home = () => {
  useNavigate();
  useChatStore((state) => state.createThread);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "home-page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "home-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "home-title", children: "你好，jelly" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "home-subtitle", children: "有什么可以帮助你的吗？" }),
...
const KnowledgePage = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "knowledge-page", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "knowledge-empty", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "上传文档构建知识库" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "upload-btn", children: "上传文档" })
  ] }) }) });
};
const ICONS = [
  "🛠️",
...
const IconPicker = ({ value, onChange }) => {
  ...
  const filteredIcons = search2 ? ICONS.filter((icon) => icon.includes(search2)) : ICONS;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "icon-picker", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "icon-picker-trigger", onClick: () => setIsOpen(!isOpen), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "icon-preview", children: value }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "icon-arrow", children: isOpen ? "▲" : "▼" })
    ] }),
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "icon-picker-dropdown", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "icon-grid", children: filteredIcons.map((icon) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
const SkillsPage = () => {
  ...
  const [importForm, setImportForm] = reactExports.useState({
    name: "",
    description: "",
    icon: "🛠️",
    path: "",
  ...
  const detectSkill = async (folderPath) => {
    setDetecting(true);
    try {
...
如果不是技能，返回：
{
  ...
  const handleDelete2 = (id2) => {
    confirm("确定要删除这个技能吗？", "确认删除").then((ok2) => {
      if (ok2) deleteSkill(id2);
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skills-page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "skills-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "技能市场" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "add-btn", onClick: handleOpen, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16 }),
        "导入技能"
      ] })
    ] }),
    showImport && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "import-form", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "图标" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            IconPicker,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "名称" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "full-width", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "描述" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "full-width", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "技能路径" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "path-input-wrapper", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "path-browse-btn", onClick: handleSelectFolder, disabled: detecting, children: [
            detecting ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 16, className: "spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 16 }),
            "浏览"
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "模式" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            value: importForm.mode,
            onChange: (e) => setImportForm({ ...importForm, mode: e.target.value }),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "companion", children: "陪伴模式" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "work", children: "工作模式" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "decision", children: "决策模式" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "reflection", children: "反思模式" })
            ]
          }
        )
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "cancel-btn", onClick: handleClose, children: "取消" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
...
const ProjectsPage = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "projects-page", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "projects-empty", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "创建项目组织你的工作" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "create-btn", children: "新建项目" })
  ] }) }) });
};
const ArtifactsPage = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "artifacts-page", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "artifacts-empty", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "AI 生成的内容会保存在这里" }) }) }) });
};
const useAppStore = create$1()(
  persist(
    (set) => ({
...
const SettingsPage = () => {
  ...
  const [localPermissionEnabled, setLocalPermissionEnabled] = reactExports.useState(permissionEnabled);
  const [localPermissionMode, setLocalPermissionMode] = reactExports.useState(permissionMode);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "权限设置" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-info", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-label", children: "权限模式" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-desc", children: "启用后，AI 执行操作需要确认" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-info", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-label", children: "默认权限" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-desc", children: "选择默认的权限级别" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "default", children: "默认询问" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "acceptEdits", children: "自动批准" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "bypassPermissions", children: "跳过确认" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "plan", children: "计划模式" })
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "模型设置" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-item clickable", onClick: () => navigate("/settings/models"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-info", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-label", children: "模型设置" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-desc", children: "管理 AI 模型列表" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 16 })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "关于" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-label", children: "版本" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-value", children: "0.3.0" })
      ] })
    ] })
  ] }) });
};
...
const ModelsPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "models-page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "models-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "AI 模型" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "add-btn", onClick: () => setIsAdding(true), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16 }),
        "添加模型"
      ] })
    ] }),
    isAdding && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-form", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "名称" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "提供商" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "minimax", children: "MiniMax" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "glm", children: "GLM" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "模型名称" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      formData.provider !== "anthropic" && formData.provider !== "ollama" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "cancel-btn", onClick: () => setIsAdding(false), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 16 }),
          "取消"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "confirm-btn", onClick: handleAdd, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 16 }),
          "添加"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "models-list", children: models.map((model) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `model-card ${model.isDefault ? "default" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-info", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-name", children: [
          model.name,
          model.isDefault && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "default-badge", children: "默认" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-meta", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "provider", children: providerLabels[model.provider] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "model-name-text", children: model.modelName })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-actions", children: [
        !model.isDefault && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => handleDelete2(model.id),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppStateProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-body", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "main-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/chat/:threadId", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ChatPage, {}) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/artifacts", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ArtifactsPage, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/settings", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPage, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/settings/models", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ModelsPage, {}) })
      ] }) })
    ] }),
